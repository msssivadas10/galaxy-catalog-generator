module powerspectrum
    !!
    !! Linear matter power spectrum models given by Eisenstein & Hu (1998)
    !!
    use iso_c_binding
    implicit none

    integer, parameter, private :: dp = c_double

    real(c_double), parameter, private :: e = 2.718281828459045_dp 
...
contains
    ...
    !============================================================================!
    !                      Baryon Acoustic Oscillation Model                     !
    !============================================================================!
